...
import { mapMutations, mapGetters } from 'vuex'
  export default {
    ...
    mounted: function() {
      this.model.id = this.detailmembre.id
      this.model.libelle = this.detailmembre.libelle
      this.model.description = this.detailmembre.description
    },
    computed: mapGetters({
      detailmembre:'membres/detailmembre'
    }),
    data: () => ({
      loading: false,
      message:null,
    ...
    methods: {
      submitForm () {
        ...
        validation && this.$msasApi.put('/membres/'+this.model.id, {...this.model})
          .then((res) => {    
