...
import { mapMutations, mapGetters } from 'vuex'
  export default {
    ...
    mounted: function() {
      this.model.id = this.detaildimension.id
      this.model.libelle_dimension = this.detaildimension.libelle_dimension
      this.selected= this.detaildimension.ligne_modes
    },
    computed: mapGetters({
      detaildimension:'dimensions/detaildimension',
    ...
    methods: {
      submitForm () {
        ...
        validation && this.$siratApi.put('/dimensions/'+this.model.id, {...this.model,ligne_modes:selectedModeFinancements})
          .then((res) => {    
