...
<v-data-table
  :headers="headers"
  :items="tab=='tout'?listmarchespublics : listmarchespublics.filter(marchepublic => marchepublic.status === tab)"
  item-key="id"
  items-per-page="20"
  class="flat pt-4"
  :loading="listmarchespublics.length?false:true" 
...
import { mapMutations, mapGetters } from 'vuex'
  export default {
    ...
    computed: mapGetters({
      listmarchespublics: 'marchespublics/listmarchespublics',
      headers: 'marchespublics/headermarchespublics',
