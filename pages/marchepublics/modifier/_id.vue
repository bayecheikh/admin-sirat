...
import FormUpdateMarchepublic from '@/components/marchepublics/modifier/FormUpdateMarchepublic';
  export default {
    layout: "dashboard",
    components: {
      LeftMenu,
      PageHeader,
      FormUpdateMarchepublic
    },
    ...
    data () {
      return {
        ...
        menu3: false,
        modal: false,
        marchepublics: ['Sperviseur national'],
