<template>
  ...
  <v-data-table
    :headers="headers"
    :items="tab=='tout'?listavisgeneraux.filter(contenu => contenu.categorie === 'avis-generaux') : listavisgeneraux.filter(contenu => contenu.categorie === 'avis-generaux' && contenu.status === tab)"
    item-key="id"
    items-per-page="20"
    class="flat pt-4"
    :loading="listavisgeneraux.length?false:true" 
  ...
  import { mapMutations, mapGetters } from 'vuex'
    export default {
      ...
      computed: mapGetters({
        listavisgeneraux: 'avisgeneraux/listavisgeneraux',
        headers: 'avisgeneraux/headeravisgeneraux',
