<template>
  ...
  <div class="custom-container mt-5">
    <v-card class="container pl-10 pt-10 pb-10 pr-10" flat>  
      <form-update-adherent></form-update-adherent>     
    </v-card>
  </div> 
</div>
</template>
...
import FormUpdateAdherent from '@/components/adherents/modifier/FormUpdateAdherent';
  export default {
    layout: "dashboard",
    components: {
      LeftMenu,
    ...
    data () {
      return {
        leftmenuItems: [
          ...
          { text: 'Liste des adherents', icon: 'mdi-account-group',link:'/adherents',position:1  }
        ],
        headerItems: [
        {
          text: 'Adherents',
