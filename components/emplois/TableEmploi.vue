...
<v-data-table
  :headers="headers"
  :items="tab=='tout'?listemplois.filter(contenu => contenu.categorie === 'emplois') : listemplois.filter(contenu => contenu.categorie === 'emplois' && contenu.status === tab)"
  item-key="id"
  items-per-page="20"
  class="flat pt-4"
  :loading="listemplois.length?false:true" 
...
import { mapMutations, mapGetters } from 'vuex'
  export default {
    ...
    computed: mapGetters({
      listemplois: 'emplois/listemplois',
      headers: 'emplois/headeremplois',
