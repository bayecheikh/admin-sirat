...
<v-data-table
  :headers="headers"
  :items="tab=='tout'?listfoiresauxquestions.filter(contenu => contenu.categorie === 'foire-aux-questions') : listfoiresauxquestions.filter(contenu => contenu.categorie === 'foire-aux-questions' && contenu.status === tab)"
  item-key="id"
  items-per-page="20"
  class="flat pt-4"
  :loading="listfoiresauxquestions.length?false:true" 
...
import { mapMutations, mapGetters } from 'vuex'
  export default {
    ...
    computed: mapGetters({
      listfoiresauxquestions: 'foiresauxquestions/listfoiresauxquestions',
      headers: 'foiresauxquestions/headerfoiresauxquestions',
